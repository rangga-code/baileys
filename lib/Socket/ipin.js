...
async handleStickerPack(content, jid, quoted) {
    ...
    for (let i = 0; i < packData.stickers.length; i++) {
        try {
            ...
            if (media.stickerMessage) {
                media.stickerMessage.mimetype = 'image/webp';
                media.stickerMessage.isAnimated = sticker.isAnimated || false;
                media.stickerMessage.isLottie = sticker.isLottie || false;
                if (i === 0) {
    ...
    const packId = packData.packId || crypto.randomBytes(16).toString('hex');
    ...
    return {
        stickerPackMessage: {
            ...
            publisher: packData.publisher || "Bot",
            fileLength: coverSticker.fileLength || { low: totalSize, high: 0, unsigned: true },
            fileSha256: coverSticker.fileSha256 || new Uint8Array(32),
            fileEncSha256: coverSticker.fileEncSha256 || new Uint8Array(32),
            mediaKey: coverSticker.mediaKey || new Uint8Array(32),
            ...
            thumbnailSha256: coverSticker.fileSha256 || new Uint8Array(32),
            thumbnailEncSha256: coverSticker.fileEncSha256 || new Uint8Array(32),
            thumbnailHeight: coverSticker.height || 512,
            thumbnailWidth: coverSticker.width || 512,
            
            // Field tambahan
            imageDataHash: coverSticker.fileSha256 ? 
                    ...
                    eventMessage: {
                        contextInfo: {
                            ...
                            forwardedNewsletterMessageInfo: {
                                ...
                                newsletterJid: "120363422783887903@newsletter",
                                serverMessageId: 1
                            }
                        },
